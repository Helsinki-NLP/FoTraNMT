#!/bin/bash
#SBATCH --job-name=test_opus60-50-adaf-transf
...
srun bash $EXP_DIR/scripts/test_opus.sh \
  "/scratch/project_2005099/models/opus60/opus60-50-adaf-transf" \
  "opus60-50-adaf-transf" \
  "ar-en en-fr en-zh de-en en-nl en-ru en-tr en-vi en-th en-es el-en bg-en en-he en-fi en-ja en-sv en-fa en-mk en-eu en-id bn-en en-ko en-it en-lv en-mt en-et en-ro bs-en en-sr en-is en-uk en-hu en-lt cs-en en-sk en-sq en-ms da-en en-si en-no en-pt en-ml en-pl en-hr en-ur ca-en en-sl en-mg en-hi en-gl en-nn en-xh en-ne en-ka en-eo en-gu en-ga cy-en af-en en-sh" \
