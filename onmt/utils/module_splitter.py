...
def build_bilingual_model(
    ...
    output_model["whole_model"].decoder_types = {
        tgt_lang: model_frame["whole_model"].decoder_types[tgt_lang]
    }
    ...
    output_model["whole_model"].tgt_vocabs = {
        tgt_lang: model_frame["whole_model"].tgt_vocabs[tgt_lang]
    }
    output_model["whole_model"]._modules["encoders"]._modules = OrderedDict(
        [
            (
                "0",
                model_frame["whole_model"]
                ._modules["encoders"]
                ._modules[str(src_langs_to_id[src_lang])],
            )
        ]
    )
    output_model["whole_model"]._modules["decoders"]._modules = OrderedDict(
        [
            (
                ...
                model_frame["whole_model"]
                ._modules["decoders"]
                ._modules[str(tgt_langs_to_id[tgt_lang])],
            )
        ]
    )
