...
def get_fields(
    ...
    assert src_data_type in ['text', 'img', 'audio', 'h5'], \
...
class DatasetLazyIter(object):
    ...
    def _iter_dataset(self, path):
        ...
        if isinstance(self.fields['src'], (AudioSeqField,h5FeatsField)):
...
def build_dataset_iter(corpus_type, fields, data_path, opt, is_train=True, multi=False):
    """
