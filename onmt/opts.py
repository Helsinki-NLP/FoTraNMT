...
def model_opts(parser):
    ...
    group.add(
        ...
        "-use_spec_augment",
        action="store_true",
        help="""Use spec augment layer during training on audio encoder""",
    )
    group.add(
        "--truncate_audiofeats",
        "-truncate_audiofeats",
...
def train_opts(parser):
    ...
    group.add(
        ...
        default=[""],
        type=str,
        help="""languages of the same language family will share an attention layer.
    ...
    group.add(
        ...
        default=[""],
        type=str,
        help="""languages of the same language group will share an attention layer.
                              If active this shared layer receives info from the lang-specific encoder.""",
    )
    ...
    group.add(
        ...
        "-use_attention_bridge",
        action="store_true",
        help="""Use self-attention layer between
            enc and dec""",
    )
    group.add(
        "--n_layers_attbrg",
...
def translate_opts(parser):
    ...
    group.add(
        ...
        "-use_attention_bridge",
        action="store_true",
        help="""Use self-attention layer
            between enc and dec""",
    )
    group.add(
        "--force_decode_first_token",
        "-force_decode",
        type=str,
        default=None,
