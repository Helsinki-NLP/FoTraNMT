#!/bin/bash
#SBATCH --job-name=test_opus24-50-adaf-transf
...
srun bash $EXP_DIR/scripts/test_opus.sh \
  "/scratch/project_2005099/models/opus24/opus24-50-adaf-transf" \
  "opus24-50-adaf-transf" \
  "ar-en en-fr en-zh de-en en-nl en-ru en-tr en-vi en-th en-es el-en bg-en en-he en-fi en-ja en-sv en-fa en-mk en-eu en-id bn-en en-ko en-it en-lv" \
